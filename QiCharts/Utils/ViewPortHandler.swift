...
open class ViewPortHandler: NSObject
{
    ...
    @objc open func centerViewPort(pt: CGPoint, chart: QiChartBaseView)
    {
        let translateX = pt.x - offsetLeft
        let translateY = pt.y - offsetTop
    ...
    @objc @discardableResult open func refresh(newMatrix: CGAffineTransform, chart: QiChartBaseView, invalidate: Bool) -> CGAffineTransform
    {
